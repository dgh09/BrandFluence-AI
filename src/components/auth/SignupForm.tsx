...
/**
 * `initialType` llega desde la portada, que tiene un botón por rol. Quien
 * pulsa «Soy una marca» debe encontrarse el formulario ya en marca; lo
 * contrario es pedirle que repita una elección que acaba de hacer.
 *
 * Lo resuelve el componente de servidor de /signup leyendo el query param,
 * y no `useSearchParams()`, que obligaría a envolver esto en un Suspense
 * porque la página se prerenderiza estática.
 */
export function SignupForm({ initialType = "creator" }: { initialType?: UserType }) {
